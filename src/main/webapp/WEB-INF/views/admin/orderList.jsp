			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<%
							com.ZhengMengen.model.Order o=(com.ZhengMengen.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.ZhengMengen.dao.UserDao userDao=new com.ZhengMengen.dao.UserDao();
						...
						<%
							...
							String paymentType=com.ZhengMengen.model.Payment.findByPaymentId(con,n);
							 %>
